    ...
    <table width=100%>
        ...
        <tr>
            <td width=2100px>Тауарлар (жұмыстар, қызметтер) жеткізуге арналған шарт (келісім-шарт)<br/>Договор(контракт)
                на поставку товаров (работ, услуг) №<u> <?php if ($firm->dog2 <> '') {
                        echo $firm->dog2;
                    } else {
        ...
        <tr>
            <td width=2100px>Тауарды жеткізу (қызметтерді, жұмыстарды) келесі сенімхат бойынша жүзеге асырылды<br/>
                Поставка товаров (работ,услуг) осуществлена по доверенности №<u> <?php echo $edit3; ?> </u></td>
            <td> (5)</td>
        </tr>
        <tr>
        ...
        <tr>
            <td width=2100px>Жүк алушы БСН<br/>Грузополучатель БИН
                <u> <?php echo $gruzopoluchatel; ?> </u></td>
            <td> (9)</td>
        </tr>
        <tr align=right>
...
<FONT size=7>
    <table width="100%">
        <tr>
            ...
            <!--<td align="left"><b>Директор<br/>Директор <?php echo trim($org->director); ?></b></td>-->
            <td></td>
            <td align="right"><b>БЕРДІ (жеткізушінің жауапты тұлғасы)<br/>ВЫДАЛ (ответственное лицо поставщика)<br/>техник
                    по учету эл.энергии Жаркенова К.А. </b></td>
        </tr>
        <tr>
            <td></td>
            <td align="center">
