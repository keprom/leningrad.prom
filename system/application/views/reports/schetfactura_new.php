...
if (strlen($schet2)==0){ echo ($schetfactura_date->id);} else {echo $schet2;} echo " от ";
 ...
 <tr>
 <td width=2100px>Тауарлар (жұмыстар, қызметтер) жеткізуге арналған шарт (келісім-шарт)<br/>Договор(контракт) на поставку товаров (работ, услуг) №<u>   <?php if ($firm->dog2<>'') {echo $firm->dog2;} else { echo $firm->dogovor."   </u> от <u>    ".datetostring($firm->dogovor_date);}?></u></td>
 <td> (3)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px>Тауар-көлік жөнелтпе құжатты <br/>Товарно-транспортная накладная <u><?php 
if (strlen($schet2)==0){ echo ($schetfactura_date->id);} else {echo $schet2;} echo " от ";
 if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;} echo " года"?> </u></td>
 <td> (7)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px>Алушының ЖСК<br/> ИИК получателя<u>   <?php echo $firm->raschetnyy_schet;?></u> в банке <u><?php echo $bank->name;?>. Код МФО: <?php echo $bank->mfo;?></u></td>
 <td> (10б)</td>
 </tr>
 </table>
 <br>
...
<tr>
	...
	<td width="200px"valign="middle">Соммасы<br/>Сумма</td>
	<td width="110px"valign="middle">Ставкасы<br/>Ставка</td>
	<td width="100px"valign="middle">Соммасы<br/>Сумма</td>
</tr>
<tr>
<td width="60px">1</td>
<td width="400px">2</td>
...
<td align="left"><b>Директор<br/>Директор <?php  echo trim($org->director); ?></b></td>
 <!--<td align="left"><b>Директор<br/>Директор <?php  echo trim($org->director); ?></b></td>-->
 <td></td>
 <td align="right"><b>БЕРДІ (жеткізушінің жауапты тұлғасы)<br/>ВЫДАЛ (ответственное лицо поставщика)<br/>техник по учету эл.энергии Жаркенова К.А. </b></td>
  </tr>
 <tr>
 <td> </td>
 <td align= "center">
 ...
 <td></td>
 <td align="right"><u><b> _________________________________________</b></u></td>
 </tr>
  <tr>
