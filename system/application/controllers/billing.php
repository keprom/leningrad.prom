...
class Billing extends Controller
{
    ...
    function schetfactura()
    {
        ...
        $data['gruzopoluchatel'] = $_POST['gruzopoluchatel'];
        $data['pokupatel'] = $_POST['pokupatel'];
        $data['pokupatel_address'] = $_POST['pokupatel_address'];
        $data['schet2'] = $_POST['schet2'];
   ...
   left join industry.billing_point on 
    ...
    function nachislenie_v_buhgalteriu()
    {
        ...
        set_time_limit(0);
        $db = dbase_open("c:/oplata/nach3.dbf", 2);
        ...
        if ($db) {
            ...
            $db2 = dbase_open("c:/oplata/nach3.dbf", 2);
            foreach ($nach->result() as $n) {
                dbase_add_record($db2,
                    array(
                        $this->d2($n->DATA),
...
where firm_id={$this->uri->segment(3)} and data_finish is null";
    ...
    public function export_rekvizit_schet()
    {
        ...
        if ($db) {
            ...
            if (!copy("c:/oplata/rschet.dbf", "c:/oplata/lengrd{$month}.dbf")) {
